...
echo " Le nom suprimé est : " .$nom."<br/>";
$tableau = array("Jean","Robert","Paul");


$tableau = array("Jean","Robert","Paul");
echo " avant suppréssion du tableau : " .count($tableau)."<br/>";
$nombre_elements= count($tableau);
for($i=0 ;$i<$nombre_elements;$i++ )
    {
$nom = array_pop($tableau);
}
echo "Le dernier non supprimé est : ".$nom."<br />";
echo "Aprés suppression , nb éléments dans le tableau : ".count($tableau)."<br/>";

//array_rand() permet de selectionner de maniére aléatoire un 
//ou plusiers éléments d'un tableau et de retourner les clé correspondante 
$tableau = array ("Jean","Robert","Paul");
$cle_aleatoire=array_rand($tableau);
echo "la valeur est donc: ".$tableau[$cle_aleatoire]."<br/>" ; 

$tableau= array ( "Jean","Robert","Paul");
$taleau_cle_aleatoire1= array_rand($tableau,2);

echo"la premiér valeur est :".$tableau[$tableau_cle_aleatoire[0]]."<br>";
echo "la deuxiemme valeur est :".$tableau[$tableau_cle_aleatoire[0]]."<br/>";
